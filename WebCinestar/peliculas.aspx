<%@ Page Title="" Language="C#" MasterPageFile="~/CineStar.Master" AutoEventWireup="true" CodeBehind="peliculas.aspx.cs" Inherits="WebCinestar.WebForm2" %>
          ...
          <asp:Repeater ID="rptPeliculas" runat="server">
              <ItemTemplate>
				<div class="contenido-pelicula">
					...
					<img src="img/pelicula/<%#Eval("id") %>" width="160" height="226"/><br/><br/>
				</div>
